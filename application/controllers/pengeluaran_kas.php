...
class Pengeluaran_kas extends OperatorController {
	...
	public function index() {
		...
		$this->data['judul_sub'] = 'Pengeluaran Kas Tunai <a href="'.site_url('pengeluaran_kas/import').'" class="btn btn-sm btn-success">Import Data</a>';
	...
	function export_excel(){
		...
		$data   = $this->pengeluaran_m->get_data_excel();
		$i	= 0;
		$rows   = array(); 
	...
	function import() {
		...
		$this->data['judul_sub'] = 'Pengeluaran Kas Tunai <a href="'.site_url('pengeluaran_kas').'" class="btn btn-sm btn-success">Kembali</a>';
		...
		if($this->input->post('submit')) {
			...
			if ( ! $this->upload->do_upload('import_pengeluran_kas')) {
	...
	function import_db() {
		if($this->input->post('submit')) {
			$this->load->model('pengeluaran_m','pemasukan', TRUE);
