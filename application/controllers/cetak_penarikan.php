...
class Cetak_penarikan extends OperatorController {
	...
	foreach ($simpanan as $row) {
		...
		$saldo_now=$this->cetak_simpanan_m->get_jenis_simpanan($row->jenis_id,$row->anggota_id);
...
<tr>
	<td> Saldo Awal </td>
	<td>:</td>
	<td>Rp. '.number_format($saldo_now+$row->jumlah).'</td>
</tr><tr>
...
<td> Saldo Akhir </td>
<td>:</td>
<td>Rp. '.number_format($saldo_now).'</td>
</tr>
<tr>
<td> Jenis Akun </td>
<td>:</td>
