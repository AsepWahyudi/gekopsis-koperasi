...
<div class="box box-solid box-primary">
	<div class="box-header">
		<h3 class="box-title">Laporan Transaksi Toko</h3>
...
<div class="box box-primary">
	<div class="box-body">
		<p></p>
		<p style="text-align:center; font-size: 15pt; font-weight: bold;"> Laporan Toko <br> <?=$tgl_periode_txt?></p>
		<table class="table table-bordered">
			...
			<tr class="header_kolom">
				...
				<th style="width:10%; vertical-align: middle; text-align:center"> Harga </th>
				<th style="width:10%; vertical-align: middle; text-align:center"> Keterangan</th>
			</tr>
			...
			<tr>
				...
				<td class="h_kanan"><?php echo number_format($is->harga); ?></td>
				<td class="h_kanan"><?=$is->keterangan?></td>
			</tr>
			<?php } ?>
			</tbody>
		</table>
...
<script type="text/javascript">
	...
	function clearSearch(){
		window.location.href = '<?php echo site_url("lap_trans_toko"); ?>';
	}
	...
	function doSearch() {
		...
		$('#fmCari').attr('action', '<?php echo site_url('lap_trans_toko'); ?>');
		$('#fmCari').submit();
	}
	...
	function cetak() {	
		...
		var win = window.open('<?php echo site_url("lap_trans_toko/cetak_laporan/?tgl_dari='+ tgl_dari +'&tgl_samp='+ tgl_samp+'"); ?>');
		if (win) {
			win.focus();
		} else {
